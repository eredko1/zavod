// MAP: RAILYARD — STUB. Owned by: RAILYARD agent (this file plus ../railyard/*.js helpers and assets/models/railyard/).
import * as THREE from 'three';

export const meta = {
  id: 'railyard', name: 'RAILYARD', subtitle: 'DAY OPS · FREIGHT YARD', time: 'day', weather: 'clear',
  description: 'Multi-level freight yard under an overcast noon sky: embankments, an overpass, signal gantries and rolling stock.',
