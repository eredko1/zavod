...
export function buildProps(world) {
  ...
  instanceModel(world, 'old_military_crate', [P(30, -6, { y: sf, ry: 0.2 }), P(30, -6, { y: sf + 0.36, ry: 0.3 }), P(22, 8, { y: ph, ry: 0.4 })], 'wood');
  instanceModel(world, 'wooden_military_crate', [P(29, 4, { y: sf, ry: 1.5 }), P(21.5, -12, { y: ph, ry: 0.3 })], 'wood');
  instanceModel(world, 'wooden_crate_01', [P(28, -9, { y: sf, ry: 0.9 }), P(22.5, 20, { y: ph, ry: 1.0 }), P(22.5, 21, { y: ph, ry: 0.4 }), P(-9.2, 50, { ry: 0.2 }), P(41, 54, { ry: 2.2 }), P(-41, 13.5, { ry: 0.1 }), P(34, 56, { ry: 0.9 })], 'wood');
  instanceModel(world, 'cardboard_box_01', [P(31, 8, { y: sf, ry: 0.4 })], 'wood', { castShadow: false });
  instanceModel(world, 'plastic_crate_01', [P(-33.4, 12.5, { ry: 0.2 })], 'metal', { castShadow: false });
  instanceModel(world, 'industrial_pastic_container', [P(-31, 16.5, { ry: 0.3 })], 'metal', { castShadow: false });
  instanceModel(world, 'ammo_box', [P(-42.5, 12, { y: 0.0, ry: 0.3 }), P(22.3, -12.4, { y: ph + 0.36, ry: 0.5 })], 'metal', { castShadow: false });
  ...
  pile(42, 40, 4); pile(-58, 44, 3); pile(52, 52, 4);
  ...
  instanceModel(world, 'concrete_road_barrier_02', [P(48.5, 2, { ry: 1.57 }), P(-29.5, 11, { ry: 0.03 })], 'concrete');
  for (const [x, z] of [[48.5, 2], [-29.5, 11]]) { world.cover(x, z + 1.1, 0, 1); world.cover(x, z - 1.1, 0, -1); }

  // carts, generators, welding, jerrycans, toolboxes, ladders, trash
  instanceModel(world, 'industrial_storage_cart', [P(20, -22, { y: ph, ry: 1.57 })], 'metal');
  instanceModel(world, 'portable_generator', [P(-30, 6, { ry: 0.6 })], 'metal');
  instanceModel(world, 'portable_welding_cart', [P(-33, -9.5, { ry: 0.4 })], 'metal');
  instanceModel(world, 'metal_jerrycan', [P(-44.8, 46, { ry: 0.3 })], 'metal', { castShadow: false });
  instanceModel(world, 'metal_toolbox', [P(20.5, -21, { y: ph, ry: 0.4 })], 'metal', { castShadow: false });
  instanceModel(world, 'ladder_sectioned_01', [P(SHED.x1 + 0.55, 20, { ry: Math.PI / 2, rx: -0.15, y: 0.05 })], 'metal', { collide: false, castShadow: false });
  instanceModel(world, 'metal_trash_can', [P(OFFICE.x1 + 1.2, 13, { ry: 0.4 }), P(24.6, -2, { y: ph, ry: 1.1 })], 'metal', { castShadow: false });
  instanceModel(world, 'trashbag', [P(OFFICE.x1 + 1.9, 13.4, { ry: 0.4 }), P(24.9, -2.7, { y: ph, ry: 2.1 }), P(-31.2, -30, { ry: 0.1 })], 'wood', { collide: false, castShadow: false });
  instanceModel(world, 'utility_box_01', [P(OFFICE.x1 + 0.3, 7.6, { ry: Math.PI / 2 }), P(SHED.x1 + 0.3, 24, { ry: Math.PI / 2 })], 'metal');
  instanceModel(world, 'power_box_01', [P(OFFICE.x1 + 0.06, 14.8, { y: 1.5, ry: Math.PI / 2 })], 'metal', { collide: false, castShadow: false });
}
