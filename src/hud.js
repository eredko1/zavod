...
function buildDOM() {
  ...
  <div class="layer ui mainmenu">
    ...
    <div class="col">
      ...
      <nav class="menu">${mi('deploy', 0, 'Deploy', 'primary')}${mi('online', 1, 'Play online')}${mi('maps', 2, 'Select map')}${mi('loadout', 3, 'Loadout')}${mi('settings', 4, 'Settings')}${mi('controls', 5, 'Controls')}</nav>
    </div>
