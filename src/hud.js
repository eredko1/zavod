...
function buildControls(H) {
  ...
  const keys = [['Move', 'W A S D'], ['Sprint', 'SHIFT'], ['Jump', 'SPACE'], ['Crouch', 'C / CTRL'], ['Fire', 'LMB'], ['Aim', 'RMB / E'], ['Scope zoom', 'WHEEL'], ['Reload', 'R'], ['Grenade', 'G'], ['Your guns (collected)', '1 – 9 / NUMPAD'], ['Quick stab', 'V'], ['Interact', 'F'], ['Swipe a car GPS', 'X'], ['Blaze / drink', 'B'], ['Vehicle camera', 'V'], ['Nitro (driving)', 'SHIFT'], ['Horn', 'Q'], ['Give a friend $10', 'N'], ['Map', 'M'], ['Radio on / off · next', 'L · .'], ['Map help card', 'H'], ['Follow a friend', 'J'], ['Respawn at spot', 'T'], ['Scoreboard', 'TAB'], ['Pause', 'ESC']];
