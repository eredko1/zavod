...
function buildDOM() {
  ...
  <div class="layer ui mainmenu">
    ...
    <div class="col">
      ...
      <nav class="menu">${mi('coney', 0, 'Play Coney with friends', 'primary')}${mi('deploy', 1, 'Deploy solo')}${mi('online', 2, 'Other rooms')}${mi('maps', 3, 'Select map')}${mi('loadout', 4, 'Loadout')}${mi('settings', 5, 'Settings')}${mi('controls', 6, 'Controls')}</nav>
    </div>
